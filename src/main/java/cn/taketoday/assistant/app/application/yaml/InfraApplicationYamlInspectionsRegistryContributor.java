...
public class InfraApplicationYamlInspectionsRegistryContributor implements InfraInspectionsRegistry.Contributor {
  public Class<? extends LocalInspectionTool>[] getInspectionClasses() {
    return new Class[] { InfraApplicationYamlInspection.class };
  }
}
