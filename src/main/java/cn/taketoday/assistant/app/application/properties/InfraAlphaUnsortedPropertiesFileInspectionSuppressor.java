...
public class InfraAlphaUnsortedPropertiesFileInspectionSuppressor implements AlphaUnsortedPropertiesFileInspectionSuppressor {

  public boolean suppressInspectionFor(PropertiesFile propertiesFile) {
    return InfraUtils.hasFacets(propertiesFile.getProject())
            && InfraConfigurationFileService.of().isApplicationConfigurationFile(propertiesFile.getContainingFile());
  }
}
