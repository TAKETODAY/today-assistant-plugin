...
public class InfraApplicationYamlSmartClassReferenceCompletionContributor extends ConfigFileSmartClassReferenceCompletionContributor {
  ...
  protected boolean isValueElement(PsiElement position) {
    return position instanceof LeafPsiElement;
  }
}
