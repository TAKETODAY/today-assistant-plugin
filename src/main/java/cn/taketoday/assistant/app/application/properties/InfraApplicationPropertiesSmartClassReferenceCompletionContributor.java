...
public class InfraApplicationPropertiesSmartClassReferenceCompletionContributor extends ConfigFileSmartClassReferenceCompletionContributor {
  ...
  protected boolean isValueElement(PsiElement position) {
    return position instanceof PropertyValueImpl;
  }
}
