...
final class InfraApplicationYamlUtil {
  ...
  static boolean isInsideApplicationYamlFile(PsiElement psiElement) {
    ...
    return originalFile instanceof YAMLFile
            && InfraConfigurationFileService.of().isApplicationConfigurationFile(originalFile);
  }
}
