...
import cn.taketoday.assistant.app.run.lifecycle.tabs.EndpointTabConfigurable;
...
final class HealthEndpointTabConfigurable extends EndpointTabConfigurable<HealthEndpointTabConfigurableUi, HealthEndpointTabSettings> {
  ...
  private HealthEndpointTabConfigurable(Project project) {
    super("HealthEndpointTabConfigurable", message("infra.application.endpoints.health.tab.configurable.name"), null);
    this.myProject = project;
  }

  public HealthEndpointTabSettings getSettings() {
    return HealthEndpointTabSettings.getInstance(this.myProject);
  }

  public HealthEndpointTabConfigurableUi createUi() {
