...
public class SpringRelatedMergeableLineMarkerInfo extends RelatedItemLineMarkerInfo<PsiElement> {
  ...
  private SpringRelatedMergeableLineMarkerInfo(PsiElement element,
          Icon icon,
          String tooltip,
  ...
  SpringRelatedMergeableLineMarkerInfo(PsiElement element,
  ...
  SpringRelatedMergeableLineMarkerInfo(PsiElement element,
          ...
          @Nullable GutterIconNavigationHandler<PsiElement> navHandler,
          NotNullFactory<? extends Collection<GotoRelatedItem>> targets,
          @Nullable @Nls String elementPresentation) {
