 ...
 */
public class InfraGroupRelatedItemLineMarkerInfo extends RelatedItemLineMarkerInfo<PsiElement> implements InfraGroupLineMarker {

  InfraGroupRelatedItemLineMarkerInfo(PsiElement element,
  ...
  public boolean canMergeWith(MergeableLineMarkerInfo<?> info) {
    return info instanceof InfraGroupLineMarker;
  }

  @Override
  public Icon getCommonIcon(List<? extends MergeableLineMarkerInfo<?>> infos) {
    return getActionGroupIcon();
  }
