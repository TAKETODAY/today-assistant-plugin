...
public abstract class CacheableElement<T extends PsiMember & PsiNamedElement> implements JamElement {
  ...
  private static final Map<String, JamAnnotationMeta> annotationMetaMap;
  static final boolean $assertionsDisabled;

  public abstract Set<String> getCacheNames();

  static {
    $assertionsDisabled = !CacheableElement.class.desiredAssertionStatus();
    CACHEABLE_ROOT_JAM_KEY = JamService.JAM_ELEMENT_KEY.subKey("SpringJamCacheableElement");
    annotationMetaMap = new HashMap<>();
  }
