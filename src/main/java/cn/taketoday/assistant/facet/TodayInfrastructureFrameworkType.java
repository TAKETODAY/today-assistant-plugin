 ...
 * @since 1.0 2022/8/22 13:08
 */
public class TodayInfrastructureFrameworkType extends LibraryBasedFrameworkType {

  public TodayInfrastructureFrameworkType() {
    super("today-infrastructure", InfraLibraryType.class);
  }
