...
public class WebMVCMatrixVariable extends JamBaseElement<PsiParameter> {
  ...
  private static final JamAnnotationMeta ANNOTATION_META = new JamAnnotationMeta(InfraMvcConstant.MATRIX_VARIABLE).addAttribute(VALUE_META).addAttribute(NAME_META).addAttribute(REQUIRED_META)
          .addAttribute(DEFAULT_VALUE_META);
  public static final JamMemberMeta<PsiParameter, WebMVCCookieValue>
          META = new JamParameterMeta<>(WebMVCCookieValue.class)
  ...
  protected WebMVCMatrixVariable(PsiElementRef<?> ref) {
    super(ref);
  }
