...
public abstract class ViewControllerBaseImpl extends DomInfraBeanImpl implements ViewControllerBase {

  @Nullable
  public String getBeanName() {
    return getPath().getRawText();
  }

  public void setName(String newName) {
    getPath().setStringValue(newName);
  }
}
