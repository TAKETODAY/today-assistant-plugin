...
public final class RestOperationsModel extends RestTemplatesModel {
  ...
  protected List<PsiMethod> getUrlApiMethods(Module module) {
    ...
    return restOperationsUtils.getRestOperationsMethods(project);
  }
  ...
  public List<PsiClass> getApiClasses(ScopedCacheValueHolder<?> scopedCacheValueHolder) {
    ...
    return RestOperationsUtils.INSTANCE.getRestOperationsApiClasses(scopedCacheValueHolder);
  }
  ...
  protected String getWebClientPackage() {
    return RestOperationsConstants.REST_OPERATIONS_PACKAGE;
  }
}
