...
@BeanType(InfraMvcConstant.FREEMARKER_CONFIGURER)
@Namespace(InfraMvcConstant.MVC_NAMESPACE_KEY)
@Presentation(typeName = WebMvcPresentationConstant.FREE_MARKER_CONFIGURER)
@BeanName("mvcFreeMarkerConfigurer")
public interface FreeMarkerConfigurer extends DomInfraBean {
