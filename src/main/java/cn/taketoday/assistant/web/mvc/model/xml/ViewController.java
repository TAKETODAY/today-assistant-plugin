...
import cn.taketoday.assistant.web.mvc.views.MVCViewConverter;

@Presentation(typeName = WebMvcPresentationConstant.MVC_VIEW_CONTROLLER, icon = "cn.taketoday.assistant.Icons.SpringBean")
