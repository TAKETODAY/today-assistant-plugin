...
public interface Interceptors extends DomElement, DomBeanContainer, BeansAndRefsType {

  List<cn.taketoday.assistant.web.mvc.model.xml.Interceptor> getInterceptors();
