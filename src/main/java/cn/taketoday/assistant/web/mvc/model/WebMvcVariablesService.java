...
public interface WebMvcVariablesService {
  ...
  static WebMvcVariablesService of() {
    return ApplicationManager.getApplication().getService(WebMvcVariablesService.class);
  }
}
