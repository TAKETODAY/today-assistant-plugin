...
@BeanType(InfraMvcConstant.VELOCITY_CONFIGURER)
@Namespace(InfraMvcConstant.MVC_NAMESPACE_KEY)
@Presentation(typeName = WebMvcPresentationConstant.VELOCITY_CONFIGURER)
@BeanName("mvcVelocityConfigurer")
public interface VelocityConfigurer extends DomInfraBean {
  @Required
