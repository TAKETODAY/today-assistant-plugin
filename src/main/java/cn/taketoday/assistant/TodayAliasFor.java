...
public class TodayAliasFor extends JamBaseElement<PsiMethod> {
  public static final SemKey<TodayAliasFor> SEM_KEY = SemKey.createKey("TodayAliasFor");
  ...
  public static final JamMethodMeta METHOD_META = new JamMethodMeta(null, TodayAliasFor.class, SEM_KEY)
          .addAnnotation(ANNO_META);

  private final PsiElementRef<PsiAnnotation> myPsiAnnotation;

  public TodayAliasFor(PsiMethod psiMethod) {
    super(PsiElementRef.real(psiMethod));
    this.myPsiAnnotation = ANNO_META.getAnnotationRef(psiMethod);
  }

  public TodayAliasFor(PsiAnnotation annotation) {
  ...
  private static class AliasForAttributePsiMethodJamConverter extends JamSimpleReferenceConverter<PsiMethod> {
    ...
    private static PsiMethod[] getAliasForMethods(JamStringAttributeElement<PsiMethod> context) {
      ...
      if (psiMethod != null) {
        PsiClass aliasForAnnotationClass = TodayAliasFor.getAliasForAnnotationClass(psiMethod);
