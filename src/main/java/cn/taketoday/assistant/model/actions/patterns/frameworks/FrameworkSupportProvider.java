...
import cn.taketoday.assistant.model.actions.patterns.frameworks.ui.LibrariesInfo;
import cn.taketoday.assistant.model.actions.patterns.frameworks.ui.TemplateInfo;
...
public interface FrameworkSupportProvider {
  ...
  Map<String, String> getPredefinedVars(Module module, XmlFile xmlFile);
