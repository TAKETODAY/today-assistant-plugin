...
import cn.taketoday.assistant.model.values.converters.resources.LangScriptValueConverter;
...
@Namespace(InfraConstant.LANG_NAMESPACE_KEY)
public interface SimpleScript extends DomElement, ScopedElement, Identified, LifecycleBean {
  ...
  @Convert(InfraBeanListConverter.class)
