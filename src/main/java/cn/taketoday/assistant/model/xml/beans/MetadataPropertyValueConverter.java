...
public class MetadataPropertyValueConverter extends PropertyValueConverter {
  ...
  public MetadataPropertyValueConverter(String requiredClass) {
    this.myRequiredClass = requiredClass;
  }

  @Nullable
  public PsiClass getRequiredType(DomElement value) {
    return DomJavaUtil.findClass(this.myRequiredClass, value);
  }
}
