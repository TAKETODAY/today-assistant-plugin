...
package cn.taketoday.assistant.model.xml.jdbc;
...
@Namespace(InfraConstant.JDBC_NAMESPACE_KEY)
public interface InitializeDatabase extends DomElement {
  @Convert(InfraBeanResolveConverter.class)
  @RequiredBeanType({ InfraConstant.JAVAX_SQL_DATA_SOURCE })
  GenericAttributeValue<BeanPointer<?>> getDataSource();
