...
public class InfraHandlersSchemasPropertiesFileInspectionSuppressor implements AlphaUnsortedPropertiesFileInspectionSuppressor {
  ...
  public boolean suppressInspectionFor(PropertiesFile propertiesFile) {
    ...
    return SPRING_HANDLERS_FILE_NAME.equals(fileName) || SPRING_SCHEMAS_FILE_NAME.equals(fileName);
  }
}
