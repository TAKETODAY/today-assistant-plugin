...
@BeanType(PlaceholderUtils.PLACEHOLDER_CONFIGURER_CLASS)
public interface PropertyPlaceholder extends DomInfraBean, InfraContextElement, InfrastructureBean {
  @Stubbed
  ...
  @Stubbed
  GenericAttributeValue<BeanPointer<?>> getPropertiesRef();
