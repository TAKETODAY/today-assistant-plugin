...
import cn.taketoday.assistant.model.xml.beans.Identified;

public interface JndiLocated extends InfraJeeElement, Identified {
  @Required
  ...
  GenericAttributeValue<BeanPointer<?>> getEnvironmentRef();

  GenericAttributeValue<Boolean> getExposeAccessContext();
