...
import cn.taketoday.assistant.model.converters.ParentRefConverter;

/**
 * http://www.springframework.org/schema/beans:refElemType interface.
 */
public interface InfraRef extends RefBase {
  ...
  @Stubbed
  GenericAttributeValue<BeanPointer<?>> getParentAttr();
