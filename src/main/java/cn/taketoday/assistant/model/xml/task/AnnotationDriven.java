...
public interface AnnotationDriven extends DomElement {
  ...
  GenericAttributeValue<BeanPointer<?>> getExecutor();

  @Convert(InfraBeanResolveConverter.class)
  @RequiredBeanType({ "cn.taketoday.scheduling.TaskScheduler", "java.util.concurrent.ScheduledExecutorService" })
  GenericAttributeValue<BeanPointer<?>> getScheduler();

  @Convert(InfraBeanResolveConverter.class)
  @RequiredBeanType({ "cn.taketoday.aop.interceptor.SimpleAsyncUncaughtExceptionHandler" })
  GenericAttributeValue<BeanPointer<?>> getExceptionHandler();
