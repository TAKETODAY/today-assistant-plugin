...
public final class InfraAbstractBeanQueryExecutor extends QueryExecutorBase<BeanPointer<?>, BeanSearchParameters.BeanClass> {
  public static final InfraAbstractBeanQueryExecutor INSTANCE = new InfraAbstractBeanQueryExecutor();

  public void processQuery(BeanSearchParameters.BeanClass params, Processor<? super BeanPointer<?>> consumer) {
    InfraXmlBeansIndex.processAbstractBeans(params, consumer);
  }
}
