...
public class AutoConfigureAfter extends AutoConfigureByClassesOrderBase {
  private static final JamAnnotationMeta ANNOTATION_META = new JamAnnotationMeta(InfraConfigConstant.AUTO_CONFIGURE_AFTER, ARCHETYPE);
  ...
  public AutoConfigureAfter(PsiElementRef<?> ref) {
    super(ref);
  }
