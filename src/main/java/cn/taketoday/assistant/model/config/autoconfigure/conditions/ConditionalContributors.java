...
public class ConditionalContributors extends KeyedExtensionCollector<cn.taketoday.assistant.model.config.autoconfigure.conditions.ConditionalContributor, String> {
