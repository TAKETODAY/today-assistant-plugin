...
public class ConditionalOnEnabledInfoContributor extends ConditionalOnEndpointBase {
  private final PsiElementRef<PsiAnnotation> myAnnotationRef;
  private static final SemKey<ConditionalOnEnabledInfoContributor> SEM_KEY = CONDITIONAL_JAM_ELEMENT_KEY.subKey("ConditionalOnEnabledInfoContributor");

  private static final String CONFIG_KEY_PREFIX = "management.info.";
  ...
  private static final JamAnnotationMeta ANNOTATION_META = new JamAnnotationMeta(InfraConfigConstant.CONDITIONAL_ON_ENABLED_INFO_CONTRIBUTOR).addAttribute(VALUE_ATTRIBUTE_META);
  private static final JamAnnotationMeta ANNOTATION_META_SB2 = new JamAnnotationMeta(InfraConfigConstant.CONDITIONAL_ON_ENABLED_INFO_CONTRIBUTOR_SB2).addAttribute(
          VALUE_ATTRIBUTE_META);
  public static final JamClassMeta<ConditionalOnEnabledInfoContributor> CLASS_META = new JamClassMeta<>(null, ConditionalOnEnabledInfoContributor.class, SEM_KEY)
          .addAnnotation(ANNOTATION_META).addAnnotation(ANNOTATION_META_SB2);
  public static final JamMethodMeta<ConditionalOnEnabledInfoContributor> METHOD_META = new JamMethodMeta<>(null, ConditionalOnEnabledInfoContributor.class, SEM_KEY)
          .addAnnotation(ANNOTATION_META).addAnnotation(ANNOTATION_META_SB2);
  ...
  public ConditionalOnEnabledInfoContributor(PsiModifierListOwner owner) {
