...
public abstract class ComponentScanExtender {
  public static final ExtensionPointName<ComponentScanExtender> EP_NAME =
          ExtensionPointName.create("cn.taketoday.assistant.componentScanExtender");

  public Collection<? extends InfraStereotypeElement> getComponents(GlobalSearchScope scope,
          Module module) {
